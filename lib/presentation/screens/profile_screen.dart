          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: selected
                  ? [
                      BoxShadow(
                        color: AppTheme.coral500.withValues(alpha: 0.30),
                        blurRadius: 10,
                        offset: const Offset(0, 3),
                      ),
                    ]
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              option(ThemeMode.light, Icons.light_mode_rounded, 'فاتح'),
              option(ThemeMode.dark, Icons.dark_mode_rounded, 'ليلي'),
              option(
